...
_Owns: Architecture and Design (docs/agent/architecture.md, docs/agent/design.md, docs/agent/data-model.md)._

- **Members:** Jefferson (Orange), Stanley (Yellow)

### 2. Organizational & Development Practices Guild

_Owns: Organizational Practices, Development Practices, and Client Interaction (docs/tribe/, AGENTS.md, CLAUDE.md)._
