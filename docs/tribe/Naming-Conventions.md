...
- _Why?_ This prevents case-sensitivity issues between Windows (local development) and Linux (Firebase/GitHub Actions CI environments).
...
_(Written and agreed upon by the Architecture / Design Guild)_
